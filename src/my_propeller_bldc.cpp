...
int main(void) {
    int pwmPin = 24; // GPIO18 = WPI2, GPIO19 = WPI24
    int range = 1024; // PWM Range --> 1024
    int clock = 94;  // ergibt ca. 200 Hz--> 94
    int pwmMin = 229;  // 5 % --> 229
    int pwmMax = 390;  // 10 % --> 390
    ...
    while (1) {
        ...
        pwmValue = pwmMin - 50; // z. B. deutlich kleiner als 225
        } else {
